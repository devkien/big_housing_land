...
<body>
    <div class="app-container" style="background: white;">
        ...
        <?php
        // Normalize avatar path so edit view matches profile/detailprofile logic
        ...
        <form action="<?php echo BASE_URL; ?>/admin/editprofile?id=<?= $user['id'] ?>" method="post" enctype="multipart/form-data">
