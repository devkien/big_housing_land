...
<body>
    <div class="app-container" style="background: white;">
        ...
        <div style="padding: 20px 15px 80px 15px;">
            ...
            <form method="post" action="<?= BASE_URL ?>/admin/cre-notification" enctype="multipart/form-data">
                ...
                <input type="text" name="ma_nhan_vien" class="input-simple-border" placeholder="Nhập mã nhân viên chốt (tùy chọn)" style="width: 200px; margin-top:15px;" value="<?= htmlspecialchars($old['ma_nhan_vien'] ?? $user['ma_nhan_su'] ?? '', ENT_QUOTES, 'UTF-8') ?>">

                <div class="upload-box-dashed" id="upload-box-notify" style="position: relative; margin-top: 20px;">
