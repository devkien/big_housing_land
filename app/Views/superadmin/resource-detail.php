        ...
        <div class="feed-list" style="padding-bottom: 80px;">
            ...
            ?>
                <article class="post-card">
                    ...
                    <div class="meta-row">
                        <span class="code-text">Mã tin: <span class="code-number">#<?= htmlspecialchars($property['ma_hien_thi'] ?? $property['id']) ?></span></span>
                    </div>
                    ...
                    <?php if (!empty($media)): ?>
                        <div class="post-images-list" style="margin-top: 15px;">
                            ...
                            ?>
                              ...
                              style="width: 100%; height: 250px; object-fit: contain; background-color: #f0f0f0; margin-bottom: 10px; border-radius: 8px;">
                            <?php endforeach; ?>
                        </div>
                    <?php endif; ?>
                </article>
