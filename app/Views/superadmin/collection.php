...
<body>
    <div class="app-container" style="background: #f9f9f9; display: flex; flex-direction: column; height: 100vh;">
        ...
        <button class="btn-create-collection" onclick="window.location.href='<?= BASE_URL ?>/superadmin/cre-collection'">
            Tạo bộ sưu tập
        </button>
    ...
    <script>
        ...
        (function() {
            ...
            if (btnConfirmRename) btnConfirmRename.addEventListener('click', function() {
                ...
                fetch('<?= BASE_URL ?>/superadmin/collection-rename', {
                    method: 'POST',
                    headers: {
            ...
            if (btnConfirmDelete) btnConfirmDelete.addEventListener('click', function() {
                ...
                fetch('<?= BASE_URL ?>/superadmin/collection-delete', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/x-www-form-urlencoded'
                    },
