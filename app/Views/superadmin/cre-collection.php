...
<body>
    <div class="app-container" style="background: #f9f9f9;">
        ...
        <header class="detail-header">
            <a href="<?= BASE_URL ?>/superadmin/collection" class="header-icon-btn"><i class="fa-solid fa-chevron-left"></i></a>
            <div class="detail-title">Tạo bộ sưu tập</div>
            <div class="header-icon-btn"></div>
        </header>

        <form method="post" enctype="multipart/form-data" style="padding: 20px 0;">
