...
<body>
    <div class="app-container" style="background: white;">
        ...
        <div style="padding: 20px 15px 80px 15px;">
            <?php
            // Normalize validation errors into the project's flash structure
            ...
            <form method="post" action="<?= BASE_URL ?>/superadmin/edit-notification?id=<?= $post['id'] ?>" enctype="multipart/form-data">
