...
<body>
    <div class="app-container" style="background: white;">
        ...
        <div id="filter-container" style="padding: 15px;">
            ...
            <input type="text" class="input-blue-border" style="margin-bottom: 10px;" id="match-location" placeholder="Nhập khu vực..." value="<?= htmlspecialchars($filters['location'] ?? '') ?>">
        ...
        <div id="result-header-container" style="padding: 0 15px; display: <?= isset($properties) ? 'block' : 'none' ?>;">
                ...
                <article class="post-card">
                    <div class="user-row">
                        <div class="user-left">
                            ...
                            <div class="user-info">
                                <div class="user-name" onclick="window.location.href='<?= BASE_URL ?>/detailprofile'">TP Nguyễn Kim Ngàn - NPHN - 888</div>
                    ...
                    <img src="<?= BASE_URL ?>/img/phongkhach.png" class="post-image-large">
                </article>
        ...
        <div id="search-modal-match" class="modal" style="display:none;">
