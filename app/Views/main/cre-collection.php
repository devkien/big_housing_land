...
<body>
    <div class="app-container" style="background: #f9f9f9;">
        ...
        <header class="detail-header">
            <a href="<?= BASE_URL ?>/collection" class="header-icon-btn"><i class="fa-solid fa-chevron-left"></i></a>
        ...
        <form method="post" action="<?= BASE_URL ?>/cre-collection" enctype="multipart/form-data" style="padding: 20px 0;">
